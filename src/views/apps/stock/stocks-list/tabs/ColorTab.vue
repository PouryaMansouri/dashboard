...
export default {
  ...
  methods: {
    ...
    selectColor(value) {
      this.$props.stock.color = value;
    },
    showColor(value) {
      const filteredData = this.optionColors.filter(
  ...
  async created() {
    this.allOptionColors = this.colors;
    this.optionColors = this.colors;
  },
};
</script>